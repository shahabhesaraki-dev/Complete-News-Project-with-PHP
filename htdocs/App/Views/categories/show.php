                            ...
                            <div class="single-job-items mb-30">
                                <div class="job-items">
                                    ...
                                    <div class="job-tittle">
                                        ...
                                        <p> <?php echo $news['summary'] ?>...<a href="/news/show/<?php echo $news['id'] ?>" style="color: #140C40; font-weight: bold">Read More</a></p>
                                    </div>
                                </div>
                            </div>
                     <?php
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-start " id="myDIV">
                                ...
                                for($page=1;$page<=$totalPage;$page++){
                                    ?>
                                    <li class="page-item <?php if($array['currentPage'] == $page) { echo " active";} ?>"><a class="page-link" href="/categories/show/<?php echo $array['category']?>/<?php echo $page?>"><?php echo $page ?></a></li>
                                    <?php
                                }
                    ...
                    <div class="single-baner-nw2 mb-30">
                        <div class="banner-img-cap2">
                            <div class="banner-img">
                                <a href="/news/show/<?php echo $news['id']?>"><img src="/uploads/<?php echo $news['image']?>" style="width: 362px; height: 294px" alt=""></a>
                            </div>
                            <div class="banner-cap2">
                                <p>Technology</p>
                                <h3><a href="/categories/show/<?php echo $news['id']?>"><?php echo $news['title']?></a></h3>
                                <p class="blog-text" style="text-transform: normal !important;"><?php echo $news['summary']?>..</p>
                            </div>
                        </div>
                    </div>
                </div>
